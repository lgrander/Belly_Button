  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'The bar chart displays if the top 10 most commen bacterial species(OTUs)<br> were found within the patient sample and the number of samples found within the patients belly button',
        showarrow: false
      }]
    };
    //console.log("hello");
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "The gauge displays the week washing frequency of the patient's belly button.",
        showarrow: false
      }]
    };
